...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(NetworkExceptions error) networkFailure,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(NetworkExceptions error)? networkFailure,
...
class __$$NetworkFailureCopyWithImpl<T, $Res>
    extends _$ApiResultCopyWithImpl<T, $Res, _$NetworkFailure<T>>
...
class _$NetworkFailure<T> implements NetworkFailure<T> {
  const _$NetworkFailure({required this.error});
  ...
  @override
  String toString() {
    return 'ApiResult<$T>.networkFailure(error: $error)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return networkFailure?.call(error);
  }
...
abstract class NetworkFailure<T> implements ApiResult<T> {
  const factory NetworkFailure({required final NetworkExceptions error}) =
      _$NetworkFailure<T>;
